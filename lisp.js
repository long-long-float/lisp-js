...
(function() {
  var CallFun, Environment, Evaluator, Lambda, List, Nil, SF_NAMES, SpecialForm, Symbol, T, currentEnv, envstack, isAtom, nil, t,
    __slice = [].slice;
  ...
  this.Parser = (function() {
    ...
    Parser.prototype.expects = function(pattern, throwing) {
      ...
      if (!valid && throwing) {
        throw "unexpected \"" + this.code[this.pos] + "\", expects \"" + pattern + "\"";
      }
      return valid;
    };
        ...
        case 'SpecialForm':
          ...
          return {
            'cond': (function(_this) {
              return function() {
                var _ref;
                return ((_ref = args.filter(function(arg) {
                  return !(_this.eval_expr(arg.values[0]) instanceof Nil);
                })[0]) != null ? _ref.values[1] : void 0) || nil;
              };
            })(this),
            'quote': function() {
              return args[0];
